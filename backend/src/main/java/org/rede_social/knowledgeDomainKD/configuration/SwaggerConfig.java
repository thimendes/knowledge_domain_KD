package org.rede_social.knowledgeDomainKD.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.rede_social.knowledgeDomainKD.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Knowledge Domain").description("Projeto API Spring - Knowledge Domain")
				.version("1.0.0").license("Apache License Version 2.0")
				.licenseUrl("https://github.com/MayaraSGS/knowledge_domain_KD").contact(contact()).build();
	}
